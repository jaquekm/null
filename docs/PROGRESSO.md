...
- [ ] **0.4** Supabase local e CLI (só `supabase init` — `supabase start` não roda neste ambiente, ver observação)
- [ ] **0.5** Migration inicial (SQL escrito, não aplicado localmente — ver observação)
